                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            Duration(milliseconds: 0),
                            () async {
                              _model.ispassNew = await actions.isValidPassword(
                                _model.passwordTextController.text,
                              );
                              _model.isValidNewPass = _model.ispassNew!;
                              safeSetState(() {});
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            Duration(milliseconds: 0),
                            () async {
                              _model.ispassConfirm =
                                  await actions.isValidPassword(
                                _model.confirmPasswordTextController.text,
                              );
                              _model.isValidConfirmPass = _model.ispassConfirm!;
                              safeSetState(() {});
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: (!_model.isValidNewPass ||
                                !_model.isValidPass ||
