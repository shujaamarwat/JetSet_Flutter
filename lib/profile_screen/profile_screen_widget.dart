...
class _ProfileScreenWidgetState extends State<ProfileScreenWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      safeSetState(() {
        _model.textController1?.text = currentUserDisplayName;
      });
      safeSetState(() {
        _model.textController2?.text = currentUserEmail;
      });
      safeSetState(() {
        _model.textController3?.text = currentPhoneNumber;
        _model.textFieldMask3.updateMask(
